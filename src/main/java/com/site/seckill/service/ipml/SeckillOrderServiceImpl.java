...
import com.site.seckill.dao.SeckillOrderMapper;
...
import com.site.seckill.redis.SeckillKey;
...
public class SeckillOrderServiceImpl implements SeckillOrderService {
    ...
    public OrderInfo insert(User user, GoodsBo goods) {
        ...
        if(success == 1) {
            ...
            orderInfo.setGoodsPrice(goods.getSeckillPrice());//秒杀商品信息，秒杀价格
    ...
    public long getSeckillResult(Long userId, long goodsId) {
        ...
        if(order != null) {//秒杀成功
            ...
            boolean isOver = getGoodsOver(goodsId);//判断秒杀是否结束
            if(isOver) {
                return -1;
            }else {
                return 0;
